...
package es.danirod.libGame.box2d;
 ...
 */
public class Box2DScreen extends es.danirod.libGame.game.BaseScreen {

    public Box2DScreen(es.danirod.libGame.game.MainGame game) {
        super(game);
    }
    ...
    public void render(float delta) {
        ...
        if (isAlive) {
            ...
            minijoeBody.setLinearVelocity(1, velocidadY);
        }
