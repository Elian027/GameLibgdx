...
package es.danirod.libGame.game.entities;
...
public class PlayerEntity extends Actor {
    ...
    public PlayerEntity(World world, Texture texture, Vector2 position) {
        ...
        setSize(es.danirod.libGame.game.Constants.PIXELS_IN_METER, es.danirod.libGame.game.Constants.PIXELS_IN_METER);
    }
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        // of the Box2D body.
        setPosition((body.getPosition().x - 0.5f) * es.danirod.libGame.game.Constants.PIXELS_IN_METER,
                    (body.getPosition().y - 0.5f) * es.danirod.libGame.game.Constants.PIXELS_IN_METER);
    ...
    public void act(float delta) {
        ...
        if (alive) {
            ...
            body.setLinearVelocity(es.danirod.libGame.game.Constants.PLAYER_SPEED, speedY);
        }

        // If the player is jumping, apply some opposite force so that the player falls faster.
        if (jumping) {
            body.applyForceToCenter(0, -es.danirod.libGame.game.Constants.IMPULSE_JUMP * 1.15f, true);
        }
    }
    ...
    public void jump() {
        ...
        if (!jumping && alive) {
            ...
            body.applyLinearImpulse(0, es.danirod.libGame.game.Constants.IMPULSE_JUMP, position.x, position.y, true);
        }
    }
