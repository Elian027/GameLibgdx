...
package es.danirod.libGame.scene2d;
...
import es.danirod.libGame.game.BaseScreen;
import es.danirod.libGame.game.MainGame;
...
public class Scene2DScreen extends BaseScreen {
    ...
    private es.danirod.libGame.scene2d.SpikeActor spikes;
    ...
    public void show() {
        ...
        spikes = new es.danirod.libGame.scene2d.SpikeActor(spikeRegion, 2100, 100, 500);
